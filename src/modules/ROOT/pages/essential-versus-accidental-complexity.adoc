...
****
My mental model has evolved somewhat, since I published this post. See
https://kieranpotts.com/standards/002#simplicity[TS-2: Software Design Philosophy > Simplicity]
for the updated iteration.
****
...
image::diagrams/accidental-essential-complexity-seesaw.svg[opts=inline]
...
in essentially simple systems – in which the domain suggests that scope will not
...
The top diagram is what you want to aim for. The bottom diagram is what you can
sometimes get away with.

image::diagrams/relative-essential-and-accidental-complexity.svg[opts=inline]
