...
image::diagrams/accidental-essential-complexity-seesaw.drawio.svg[This diagram shows a seesaw with "accidental complexity" on one side and "essential complexity" on the other.,opts=inline]
