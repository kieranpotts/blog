...
image::diagrams/accidental-essential-complexity-seesaw.svg["This diagram shows a seesaw with 'accidental complexity' on one side and 'essential complexity' on the other.",353,153,opts=inline]
