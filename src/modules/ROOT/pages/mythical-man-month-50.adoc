...
image::diagrams/men-versus-months.drawio.svg[This is a line chart with "men" on the x axis and "months" on the y axis. There are no units. THere's a single line, initially sloping downwards from left-to-right, then turning upwards.]
