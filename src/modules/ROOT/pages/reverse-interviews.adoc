...
You are looking for a _combination_ of red flags, not any single one. One red flag on its own is rarely a problem. But a cluster of red flags is likely a symptom of some deep-rooted structural problems.
