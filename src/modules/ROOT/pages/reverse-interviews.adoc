...
So far, so checkboxy. But from this baseline of understanding of the role you want to drill down into exactly what _success looks like_ in the role. Here are some questions to help you uncover this:
...
You are looking for a _combination_ of red flags, not any single one. One red flag on its own is rarely a problem. But a cluster of red flags is likely a symptom of deep-rooted structural problems.
