...
The solution offered by Brooks is to have one system architect who designs the whole system from top-to-bottom. The "`design must proceed from one mind, or from a very small number of agreeing resonated minds`", to maintain conceptual integrity.
