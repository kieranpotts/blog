...
* The *conceptual integrity* of a system is critical to its success. This is especially difficult to maintain in large-scale software systems because of the division of labor. System architects are required to oversee the overall design strategy.
...
The opening chapter delivers Brooks's sharp post-mortem of the OS/360 project. He concludes that the fundamental reason for the project's difficulties was that the managers had seriously underestimated the overall costs of delivering such a large-scale software system. This happened because the estimates were based solely on the construction of the individual parts of the system. What the managers had not accounted for was: (a) the integration costs of all those components; and (b) the "productization" of the whole solution.
...
Despite the immense technological advances of the last half-century – in computer hardware, in programming languages and runtime environments, and in tools and automation that support every aspect of software delivery – the core challenges of large-scale software development remain much the same. Cost overruns, and other modes of project failure, are still all-too common.
...
The eponymous second chapter deals with the perennial issue of software projects being reliably delivered much later than estimated. Brooks explores numerous reasons why estimating and scheduling of software projects is so hard. Are these explanations still relevant today?
...
Brooks observes that the more complex the interrelationships between the component parts of the system under construction, the greater this effect. Hence the management of complexity is identified as the essential challenge of software development.
...
In the delivery of commercial software, we have a tendency to take the third option: to turn up the heat and try to deliver products within the schedules desired by the customers. "False scheduling to match the patron's desired date is much more common in our discipline than elsewhere in engineering," Brooks observes.
