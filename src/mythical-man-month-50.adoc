...
Frederick P Brooks Jr's classic book _The Mythical Man-Month: Essays on Software Engineering_ was published in 1975 – 50 years ago. The book was one of the first published analyses of the challenges of large-scale software development – an emerging field in 1975. It introduced many ideas and principles that were hugely influential on early practitioners of our craft.

But which ideas have withstood half a century of technological change, and which have not?

I got myself a copy of the original 1975 edition and the extended 20th anniversary (1995) edition, which added two retrospective chapters. Here are my thoughts, chapter by chapter.
...
Throughout the book, Brooks draws on his own experiences, notably as the manager overseeing the initial design of IBM's ambitious OS/360 project. At the peak of the project, more than 1,000 people were working on OS/360. This was one of the biggest software projects ever attempted at the time. But, Brooks acknowledges, the project was not "wholly successful". OS/360 was delivered "late, it [used] more memory than planned, the costs were several times the estimate, and [the first version] did not perform very well".

Brooks offers an explanation for the failures of the OS/360 project. This chapter of the book serves as Brooks's post-mortem analysis.

Brooks writes that the estimates for OS/360's delivery were based on the construction of individual parts of the system, as if each part were developed as a standalone program for "private use". What they did not account for was (a) the integration costs of all those components, and (b) the "productization" of the system as a whole, ie. preparing it for general use as shrink-wrapped software.

Brooks estimates that the overhead of designing the interfaces between all the interfaces of all the components, coordinating their integration, and the incremental integration testing, adds a multiplier of about three to the cost of building all the components individually – as if they were standalone libraries.

And there's another cost factor for the work needed to prepare a completed software system for general use by the general public, rather than for single use by a single organization. Software _products_ have additional performance constraints that require greater design effort. Much extra testing and rework is needed to make software systems run reliably in "many operating environments, for many sets of data". Add in costs for user documentation and packaging, and you have another cost multiplier of about three for "productization" of a software system.

All told, large-scale, general-purpose, shrink-wrapped software products cost about nine times the cost of constructing all the individual components of the system in isolation, as though they were standalone programs intended only for private use.

Brooks reflects that large-scale software development is inherently hard. The reality of developing commercial software for a living, Brooks writes, is that there are many "dreary hours of tedious, painstaking labor", often involving analysis of code written by other people who have moved on to other projects already.

50 years later, this all sounds disappointingly familiar.

Despite the immense technological advances of the last 50 years – in computer hardware, in programming languages and runtime environments, and in tools and automation that support every aspect of software delivery – the core challenges of large-scale software development remain largely the same as they ever were. Project failures remain commonplace.

Will we ever free ourselves from the tar pit?

Unfortunately, I do not believe so.

Throughout the history of computing, advances in technology have created opportunities for ever more ambitious software. The resources and tools at our disposal are as powerful as they have ever been – think cloud computing, xxxx, xxxxx. But the productivity gains afforded by these tools are offset by the increases in complexity of the software that exists in the world today.

Of course, some of the challenges today are different from what they were in the time of OS/360. We are no longer physically constrained by computing resources – these are abundant, easily sourced, and cheap. Yet physical constraints remain for many categories of software – xxxxxxxx.

But the essential craft of software development remains the management of complexity. The core skill of computer programming is the extraction of simple models from complex domains.
...
2. *Progress is not always directly correlated with effort*: xxxxx

3. *Regenerative schedule disaster*: xxxx

4. *Systems testing must be done last*: xxxxx

5. *Gutless estimating*: xxxxx
