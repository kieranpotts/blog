...
https://en.wikipedia.org/wiki/Fred_Brooks[Frederick P Brooks Jr's] classic book _The Mythical Man-Month: Essays on Software Engineering_ was published in 1975 – 50 years ago. The book was one of the first published analyses of the challenges of large-scale software development.
...
* Conceptual integrity is especially difficult to maintain in large-scale software systems because of the division of labor. The solution is for system architects to design the whole system from top-to-bottom (*top-down design*).

* There are many reasons why software projects are notorious for taking longer to complete than expected. Optimism in estimates, ineffective monitoring of progress during construction, and the emergence of bugs late in the process, are all common causes of cost overruns. But perhaps the most convincing reason is that we have a habit of trying to accommodate our customers' deadlines rather than negotiating realistic schedules based on data-driven projections.

* Adding manpower to a late software project makes it later – Brooks's Law. More people means more overhead in terms of communication and training. In addition, some programming tasks must be done sequentially and cannot be parallelized. All software projects have an optimal division of labour and delivery cannot be further optimized beyond this point.
...
The opening chapter delivers Brooks's sharp post-mortem of the OS/360 project. He concludes that the fundamental reason for the project's difficulties was that the overall costs of delivering such a large-scale software system were seriously underestimated. This happened because the estimates were based solely on the construction of the individual parts of the system. What they had not accounted for was: (a) the integration costs of all those components; and (b) the "productization" of the whole solution.
...
The eponymous second chapter deals with the perennial issue of software projects being delivered much later than estimated. Brooks explores numerous reasons why estimating and scheduling of software projects is so hard. Are these explanations still relevant today?
...
This graph shows that software projects have an optimal division of labour – where delivery is maximized by efficient allocation of resources – and delivery cannot be further optimized beyond this point. Brooks observes that the more complex the interrelationships between the component parts of the system under construction, the greater this effect. Hence the management of complexity is identified as the core challenge of software development. The simpler the design, the more opportunities you will have to build faster if you need to.
...
Brooks is most convincing in his argument that the very notion that the development of software can be accurately estimated is deeply flawed. Software development is an inherently complex and unpredictable activity. In every software project, even those with stable and known requirements, there will always be some requirements that are emergent. Requirements may emerge only through design and construction, or even later still, when working software is finally put into the hands of real users. This is the nature of software development, which is more of a design problem than a construction task.

The misplaced belief that the delivery of complex software can be planned in meticulous detail is still widely held in 2025.
...
I'm the least convinced by Brooks' explanation that poor estimation is a consequence of the relatively young ages of computer programmers. Sure, younger developers lack the necessary experience to do accurate estimates, but in my experience senior developers can be just as guilty of optimism bias. Contingency planning and risk management are still poorly practiced in many software projects today – regardless of who's drawing up the project plans.
...
Good estimation is done bottom-up from low-level technical designs, rather than top-down from high-level business requirements. But commercial pressures often force estimates to be done from requirements rather than from designs. And gutless estimation, in which managers produce estimates that align with business expectations rather than technical realities, is still all-too common.
...
The dominant theme throughout _The Mythical Man-Month_ is the question of how best to manage complexity in large-scale software systems. Maintaining conceptual integrity, Brooks argues, is the best way of containing complexity.

Conceptual integrity is a quality of a system that emerges from its high-level design. A system with high conceptual integrity is one where all its concepts, and their relationships with each other, are applied in a consistent way throughout. A consistent design philosophy flows through all subsystems. Anywhere you look in the codebase, you can tell it is part of the same system.

A system with high conceptual integrity tends to be easy to maintain. We can more confidently change parts of such systems, because we can draw upon our mental map of the architecture and understand intuitively the full repercussions of making our changes.
...
I think few modern architects would dispute Brooks's notion that conceptual integrity is one of the most important principles of software design, though today we are more likely to use alternative terms like "cohesion" and "consistency".
...
The difficult is in achieving it. For a system to have high conceptual integrity, Brooks says "the entire system... requires a system architect to design it all, from the top down". This is difficult to do in large-scale software projects because of the division of labour. The implementation is necessarily broken up into lots of small pieces, each designed and constructed independently by different programmers.

The solution offered by Brooks is to have one system architect who designs the whole system from top-to-bottom. Brooks says the system architect should stick with the design of the overall system, and not get involved with the implementation of individual parts. In Brooks's development model, design and implementation are two distinct phases. First, a system architect defines the design specifications, then the builders arrive and define the implementation specifications.

Today, we know this development model as *top-down design*. In this design process, you start with a clear understanding of the overall architectural style that you want to achieve, and the architectural patterns that you want to use. Within that overall design framework, the solution is broken down into a hierarchy of smaller, more manageable subsystems, modules, and components – each initially designed as a black box (their interfaces specified but their internal workings left unspecified). Each component is then refined in a stepwise fashion, with internal details described in greater detail. Additional levels of dependencies and interactions are added incrementally, until the complete system is fully specified.
...
In 2025, the challenge remains maintaining conceptual integrity at scale. The larger the system, the greater the division of labor, and therefore the harder it is to maintain the conceptual integrity of the overall system design.
