...
Software development is just one very thin slice of the overall software development life cycle.
...
.Related links
****
* https://www.economist.com/business/2022/01/29/what-if-all-workers-wrote-software-not-just-the-geek-elite[What if all workers wrote software, not just the geek elite?] – The Economist, 29 January 2022 (paywall)
* https://www.economist.com/science-and-technology/2021/07/07/ai-is-transforming-the-coding-of-computer-programs[AI is transforming the coding of computer programs] – The Economist, 7 July 2021 (paywall)
* https://interconnect.substack.com/p/ai-will-create-more-developers-not[AI will create more developers, not less] – Kevin Xu makes the argument that there are still many human process that are not yet automated by software (2023)
* https://nocodelist.co/[NoCodeList] — Directory of "no code" apps
* https://www.nocode.tech/[NoCode.Tech] – A rich repository of tools and knowledge for non-programmers looking to get involved in the "no code movement"
* https://matthewstrom.com/writing/design-by-wire/[Design-by-wire] – Matthew Ström (2023) makes the case why AI will shape designers, not replace them
* https://www.youtube.com/watch?v=uxBZFju0Mjs[Will low-code/no-code kill programming jobs?] – Dave Farley's thoughts (2022)
****
