...
For these reasons, the quality attributes of software are not easily measurable and verifiable. Metrics such as cyclometric complexity can alert us to code smells, but those should always be evaluated via more qualitative assessments of the code.
