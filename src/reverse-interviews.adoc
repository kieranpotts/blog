...
TODO: Questions to identify Tactical versus strategic companies 
TODO: Questions to uncover top-down management
TODO: Questions to discover toxicity

TODO: Do you contribute to open source? This tells you something about values - willing to give back to the community from which you derive value.
...
TODO: Trustpilot, Google Maps, etc. as alternative sources to Glassdoor. Crunchbase too.
