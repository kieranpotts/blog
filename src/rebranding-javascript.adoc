...
image::./_/media/images/js.png[A yellow square with the letters JS in black in the bottom-right corner,400,400,link=https://github.com/voodootikigod/logo.js]
