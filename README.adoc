...
Optionally, new blog posts may be created in `feature/*` side branches, which are squash-merged into `dev` when ready for publication. Other changes can be committed directly to the `dev` branch.
